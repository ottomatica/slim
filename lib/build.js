...
const formatSteps = {
    'raw': [dockerBuild, dockerExport, rawExtract, buildRootfsImage, cleanup],
    'iso': [dockerBuild, dockerExport, rawExtract, buildRootfsImage, isoBuild, cleanup],
    'qcow2': [dockerBuild, dockerExport, rawExtract, buildRootfsImage, isoBuild, qcowBuild, cleanup]
};
